...
class Candidate(Base):
    ...
    # ── GDPR COMPLIANCE ───────────────────────────────────────
    # HR must confirm candidate consent before uploading CV.
    # Without consent, upload is blocked.
    consent_given = Column(Boolean, default=False, nullable=False)

    # Auto-delete date — set to DATA_RETENTION_DAYS from upload.
    # A startup cleanup job deletes candidates past this date.
