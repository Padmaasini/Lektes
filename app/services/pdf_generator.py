"""
TalentMesh PDF Report Generator
...
def generate_pdf_report(job_title: str, hr_email: str, candidates: List[dict]) -> bytes:
    ...
    # ── HEADER BANNER ─────────────────────────────────────────────────────────
    header_data = [[
        Paragraph('<font color="#ffffff" size="14"><b>🌿 TalentMesh</b></font>', styles['Normal']),
    ...
    story.append(Paragraph(
        'Generated by TalentMesh · talentmesh.nimbus-24.com · AI-powered recruitment screening',
